...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['text_consulting'] = $this->language->get('text_consulting');
		...
		$data['review'] = $this->url->link('catalog/oreview', 'token=' . $this->session->data['token'], 'SSL');
			$data['consulting'] = $this->url->link('catalog/askquestion', 'token=' . $this->session->data['token'], 'SSL');
