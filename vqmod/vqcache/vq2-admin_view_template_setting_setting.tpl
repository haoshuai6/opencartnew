          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-option">
              ...
              <fieldset>
                    ...
                    <div class="well well-sm" style="height: 150px; overflow: auto;">
                      ...
                      <div class="radio">
                        <label>
                          ...
                          <input type="radio" name="config_complete_status[]" value="<?php echo $order_status['order_status_id']; ?>" checked="checked" />
                          <?php echo $order_status['name']; ?>
                          <?php } else { ?>
                          <input type="radio" name="config_complete_status[]" value="<?php echo $order_status['order_status_id']; ?>" />
                          <?php echo $order_status['name']; ?>
                          <?php } ?>
                        </label>
                      </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-unpaid-status"><span data-toggle="tooltip" title="<?php echo $help_unpaid_status; ?>"><?php echo $entry_unpaid_status; ?></span></label>
                  <div class="col-sm-10">
                    <select name="config_unpaid_status_id" id="input-unpaid-status" class="form-control">
                      <?php foreach ($order_statuses as $order_status) { ?>
                      <?php if ($order_status['order_status_id'] == $config_unpaid_status) { ?>
                      <option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
                      <?php } else { ?>
                      <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                      <?php } ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <div class="well well-sm" style="height: 150px; overflow: auto;">
                      ...
                      <div class="checkbox">
                        <label>
                          <?php if (in_array($order_status['order_status_id'], $config_paid_status)) { ?>
                          <input type="checkbox" name="config_paid_status[]" value="<?php echo $order_status['order_status_id']; ?>" checked="checked" />
                          <?php echo $order_status['name']; ?>
                          <?php } else { ?>
                          <input type="checkbox" name="config_paid_status[]" value="<?php echo $order_status['order_status_id']; ?>" />
                          <?php echo $order_status['name']; ?>
                          <?php } ?>
                        </label>
                      </div>
                    ...
                    <?php if ($error_paid_status) { ?>
                    <div class="text-danger"><?php echo $error_paid_status; ?></div>
                    <?php } ?>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-shipped-status"><span data-toggle="tooltip" title="<?php echo $help_shipped_status; ?>"><?php echo $entry_shipped_status; ?></span></label>
                  <div class="col-sm-10">
                    <select name="config_shipped_status_id" id="input-shipped-status" class="form-control">
                      <?php foreach ($order_statuses as $order_status) { ?>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-cancled-status"><span data-toggle="tooltip" title="<?php echo $help_cancled_status; ?>"><?php echo $entry_cancled_status; ?></span></label>
                  <div class="col-sm-10">
                    <select name="config_cancled_status" id="input-cancled-status" class="form-control">
                      <?php foreach ($order_statuses as $order_status) { ?>
                      <?php if ($order_status['order_status_id'] == $config_cancled_status) { ?>
                      <option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
                      <?php } else { ?>
                      <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                      <?php } ?>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-cancled-time"><span data-toggle="tooltip" title="<?php echo $help_complete_time; ?>"><?php echo $entry_complete_time; ?></span></label>
                  <div class="col-sm-10">
                    <input type="text" name="config_complete_time" value="<?php echo $config_complete_time; ?>" placeholder="<?php echo $entry_complete_time; ?>" id="input-cancled-time" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-unpaid-time"><span data-toggle="tooltip" title="<?php echo $help_unpaid_time; ?>"><?php echo $entry_unpaid_time; ?></span></label>
                  <div class="col-sm-10">
                    <input type="text" name="config_unpaid_time" value="<?php echo $config_unpaid_time; ?>" placeholder="<?php echo $entry_unpaid_time; ?>" id="input-unpaid-time" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
