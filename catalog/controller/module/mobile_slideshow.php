...
class ControllerModuleMobileSlideshow extends Controller {
	public function index($setting) {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/mobile_slideshow.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/module/mobile_slideshow.tpl', $data);
		} else {
			return $this->load->view('default/template/module/mobile_slideshow.tpl', $data);
		}
	}
}
