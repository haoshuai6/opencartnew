...
class ControllerCommonCart extends Controller {
	public function index() {
		...
		$data['text_items'] = sprintf($this->language->get('text_items'), $this->cart->countProducts() + (isset($this->session->data['vouchers']) ? count($this->session->data['vouchers']) : 0) + (isset($this->session->data['recharges']) ? count($this->session->data['recharges']) : 0), $this->currency->format($total));
