...
<div id="content"><?php echo $content_top; ?>
  ...
  <!-- 快递单详情 -->
  <?php if ($order_kuaidi_code != '' && $order_kuaidi_number != '') { ?>
  <h2><?php echo $text_kuaidi; ?></h2>
  <div id="kuaididan"></div>
  
  <script type="text/javascript">
  	//ajax调取数据信息
	$('#kuaididan').load('index.php?route=module/kuaidi_chaxun&order_kuaidi_code=<?php echo $order_kuaidi_code; ?>&order_kuaidi_number=<?php echo $order_kuaidi_number; ?>');
  </script> 
