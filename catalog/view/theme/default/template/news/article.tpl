...
<?php if ($acom != 0 && !$disqus_status && !$fbcom_status) { ?>
    ...
    <div class="form-group" style="overflow:hidden;">
		  ...
		  <div class="col-sm-10">
		    <input class="form-control" type="text" name="name" value="<?php echo $customer_name; ?>" />
		  </div>
	  </div>
    <div class="form-group" style="overflow:hidden;">
		  <label class="col-sm-2 control-label" for="input-review"><?php echo $entry_review; ?></label>
		  <div class="col-sm-10">
		    <textarea class="form-control" name="text" cols="40" rows="4"><?php echo $customer_name; ?></textarea>
		  </div>
	  </div>
    <?php echo $captcha; ?>
    </div>
