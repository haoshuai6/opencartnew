...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['entry_cancled_status'] = $this->language->get('entry_cancled_status');
		...
		$data['help_cancled_status'] = $this->language->get('help_cancled_status');
		...
		if (isset($this->request->post['config_unpaid_status'])) {
			$data['config_unpaid_status'] = $this->request->post['config_unpaid_status'];
		} elseif ($this->config->get('config_unpaid_status')) {
			$data['config_unpaid_status'] = $this->config->get('config_unpaid_status');
		} else {
			$data['config_unpaid_status'] = 0;
		}
		...
		if (isset($this->request->post['config_cancled_status'])) {
			$data['config_cancled_status'] = $this->request->post['config_cancled_status'];
		} elseif ($this->config->get('config_cancled_status')) {
			$data['config_cancled_status'] = $this->config->get('config_cancled_status');
		} else {
			$data['config_cancled_status'] = 0;
		}
