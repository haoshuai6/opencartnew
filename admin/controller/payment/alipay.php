...
class ControllerPaymentAlipay extends Controller {
	...
	public function index() {
		...
		$data['action'] = HTTPS_SERVER . 'index.php?route=payment/alipay&token=' . $this->session->data['token'];
		...
		if (isset($this->request->post['alipay_currency_code'])) {
			$data['alipay_currency_code'] = $this->request->post['alipay_currency_code'];
		} else {
			$data['alipay_currency_code'] = $this->config->get('alipay_currency_code');
		}
		...
		if (isset($this->request->post['alipay_wait_buyer_pay'])) {
			$data['alipay_wait_buyer_pay'] = $this->request->post['alipay_wait_buyer_pay'];
		} else {
			$data['alipay_wait_buyer_pay'] = $this->config->get('alipay_wait_buyer_pay'); 
		} 
		
		if (isset($this->request->post['alipay_wait_buyer_confirm'])) {
			$data['alipay_wait_buyer_confirm'] = $this->request->post['alipay_wait_buyer_confirm'];
		} else {
			$data['alipay_wait_buyer_confirm'] = $this->config->get('alipay_wait_buyer_confirm'); 
		} 		
		
		if (isset($this->request->post['alipay_trade_finished'])) {
			$data['alipay_trade_finished'] = $this->request->post['alipay_trade_finished'];
		} else {
			$data['alipay_trade_finished'] = $this->config->get('alipay_trade_finished'); 
		} 		
		
		if (isset($this->request->post['alipay_wait_seller_send'])) {
			$data['alipay_wait_seller_send'] = $this->request->post['alipay_wait_seller_send'];
		} else {
			$data['alipay_wait_seller_send'] = $this->config->get('alipay_wait_seller_send'); 
		} 
